...
export default defineComponent({
    setup() {
        ...
        onMounted(async () => {
            const images = import.meta.glob('@/stores/photos/artwork/*.jpg');
...
function __VLS_template() {
    ...
    for (const [image, index] of __VLS_getVForSourceType((__VLS_ctx.artwork))) {
        __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ onClick: (...[$event]) => {
                    __VLS_ctx.openModal(image);
                } }, key: ((index)), ...{ class: ("collage-item") }, });
        __VLS_elementAsFunction(__VLS_intrinsicElements.img)({ src: ((image)), alt: ("Artwork"), });
    }
    ...
    if (__VLS_ctx.showModal) {
        ...
        __VLS_elementAsFunction(__VLS_intrinsicElements.img)({ src: ((__VLS_ctx.modalImage ?? '')), alt: ("Fullscreen Artwork"), });
