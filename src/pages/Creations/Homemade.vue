  ...
  <v-container style="justify-content: center">
    <v-row>
      <v-col cols="12">
        ...
        <p>Welcome to the gallery of homemade goods! Click a pic for a fullscreen view!</p>
      </v-col>
      <v-row style="justify-content: center">
        <div class="collage">
          <div
            v-for="(image, index) in homemade"
            :key="index"
            class="collage-item"
            @click="openModal(image)"
          >
            <img :src="image" alt="homemade" />
          </div>
        </div>
      </v-row>
    </v-row>
    ...
    <div v-if="showModal" class="modal-overlay" @click="closeModal">
      <div class="modal-content" @click.stop>
        <img :src="modalImage" alt="Fullscreen homemade" />
