...
export default defineComponent({
    setup() {
        ...
        onMounted(async () => {
            const images = import.meta.glob('@/stores/photos/homemade/*.jpg');
        ...
        return { homemade, showModal, modalImage, openModal, closeModal };
    }
});
function __VLS_template() {
    ...
    /** @type { [typeof __VLS_components.VRow, typeof __VLS_components.vRow, typeof __VLS_components.VRow, typeof __VLS_components.vRow, ] } */
    // @ts-ignore
    const __VLS_19 = __VLS_asFunctionalComponent(__VLS_18, new __VLS_18({ ...{ style: ({}) }, }));
    ...
    for (const [image, index] of __VLS_getVForSourceType((__VLS_ctx.homemade))) {
        __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ onClick: (...[$event]) => {
                    __VLS_ctx.openModal(image);
                } }, key: ((index)), ...{ class: ("collage-item") }, });
        __VLS_elementAsFunction(__VLS_intrinsicElements.img)({ src: ((image)), alt: ("homemade"), });
    }
    ...
    if (__VLS_ctx.showModal) {
        ...
        __VLS_elementAsFunction(__VLS_intrinsicElements.img)({ src: ((__VLS_ctx.modalImage ?? '')), alt: ("Fullscreen homemade"), });
